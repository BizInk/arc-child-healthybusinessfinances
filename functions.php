...
$sage_includes = [
  ...
  'lib/luca/theme.php',            // Theme-specific functions
];
...
$myUpdateChecker = PucFactory::buildUpdateChecker('https://github.com/BizInk/arc-child-healthybusinessfinances',__FILE__,'arc-child-healthybusinessfinances');
